...
export const PRODUCTS : Product[] = [
    ...
    { id: 4, companyName: 'Fanie Mae Heloc', year: 30, rate: 4.75 },
    { id: 5, companyName: 'Freddie Mac Conventional', year: 30, rate: 5.75 },
    { id: 6, companyName: 'VA Arm', year: 30, rate: 4.05 }
